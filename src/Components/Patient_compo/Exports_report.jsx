...
const Exports_report = () => {
    // Access the specific data for the 'exports_report' page
    const { title, subtitle } = dashboardData.exports_report;
